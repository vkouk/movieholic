...
export const storeRent = (rentValues, history) => async dispatch => {
  await axios
    .post(`${Config.API_URL}/rent`, rentValues)
    .then(() => {
...
export const getRent = rentId => async dispatch => {
  await axios
    .get(`${Config.API_URL}/rent/${rentId}`)
...
export const getUserRents = userId => async dispatch => {
  await axios
    .get(`${Config.API_URL}/rent/user/${userId}`)
...
export const returnRent = (returnValues, history) => async dispatch => {
  await axios
    .post(`${Config.API_URL}/rent/return`, returnValues)
    .then(() => {
