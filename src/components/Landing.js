            ...
            <div className="bg-black-80 pb5 pb6-m pb7-l hero__container">
              ...
              <div className="tc-l mt4 mt5-m mt6-l ph3">
                <h1 className="f2 f1-l fw2 white-90 mb0 lh-title">
                  movieholic - Rent hasn't become easier
                </h1>
                <h2 className="fw1 f3 white-80 mt3 mb4">
                  Search &amp; Rent for your favorite movies &amp; series.
                </h2>
                <Link
                  className="hero__link f6 no-underline grow dib v-mid white ba b--white ph3 pv2 mb3"
                  to={"/movies"}
                >
                  Movies
                </Link>
                ...
                <h2 className="fw1 f3 white-80 mt3 mb4">
                  Below are all your recommended movies &amp; series, and search
                  to browse new one!
                </h2>
              </div>
            </div>
