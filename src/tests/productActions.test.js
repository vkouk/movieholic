...
describe('movie/serie actions', () => {
    ...
    describe('fetch movies/series', () => {
        it('should fetch data', () => {
            const moviesData = { type: types.FETCH_MOVIES, payload: { id: 1, title: 'batman', stock: 1, genre: 'Action', released: '25/12/2018' } };
            const seriesData = { type: types.FETCH_SERIES, payload: { id: 1, title: 'daredevil', stock: 1, genre: 'Action', released: '25/12/2018' } };
    ...
    describe('fetch movie/serie by title', () => {
        it('should fetch data by title', () => {
            const moviesData = { type: types.GET_MOVIE, payload: { title: 'batman' } };
            const seriesData = { type: types.GET_SERIE, payload: { title: 'daredevil' } };
