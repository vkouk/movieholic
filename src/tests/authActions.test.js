...
describe('auth actions', () => {
    ...
    describe(`update user's profile`, () => {
        it('should update user profile', () => {
            const userData = { type: types.UPDATE_USER, payload: { id: 1, email: 'test@test.com', password: 12345 } };
    ...
    describe('add user balance', () => {
        it ('should add user balance', () => {
            const userData = { type: types.UPDATE_USER, payload: { amount: 5, id: 'tok_12345visa', userId: 1 } };
