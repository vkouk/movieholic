...
describe('rent/cart actions', () => {
    ...
    describe('store rent', () => {
        it('should store rent values', () => {
            ...
            store.dispatch(actions.storeRent(rentValues))
                .then(() => {
    ...
    describe('return rent', () => {
        it('should return rent values', () => {
            const returnValues = { type: types.RETURN_ORDER, payload: { rentId: 123, id: 'tok12345visa' } };
            ...
            store.dispatch(actions.returnRent(returnValues))
                .then(() => {
                    expect(store.getActions().toEqual(expectedActions));
                });
        })
    ...
    describe('get rents/rent/user Rents', () => {
        it('should get all rents', () => {
            ...
            store.dispatch(actions.getRents())
                .then(() => {
                    expect(store.getActions().toEqual(expectedActions));
                });
        });
        ...
        it('should get rent by id', () => {
            ...
            store.dispatch(actions.getRent(rentData.payload))
                .then(() => {
                    expect(store.getActions().toEqual(expectedActions));
                });
        });
        ...
        it('should get user rents by user id', () => {
            ...
            store.dispatch(actions.getRent(userData.payload))
                .then(() => {
                    expect(store.getActions().toEqual(expectedActions));
                });
        });
    ...
    describe('add/remove/calculate cart items', () => {
        it('should add values to cart', () => {
            const cartValues = [{ type: types.ADD_TO_CART, payload: { id: 1, title: 'daredevil', stock: 1, genre: 'Action', released: '25/12/2018' } }, { type: types.ADD_TO_CART, payload: { id: 2, title: 'batman', stock: 2, genre: 'Action', released: '25/12/2018' } }];
            ...
            store.dispatch(actions.addToCart({ ...cartValues[0].payload, ...cartValues[1].payload }))
                .then(() => {
                    expect(store.getActions().toEqual(expectedActions));
                });
        });
        ...
        it('should calculate total cart amount', () => {
            const cartTotal = { type: types.CALCULATE_CART_TOTAL, payload: { total: 10 } };
            ...
            store.dispatch(actions.cartTotalAmount(cartTotal.payload))
                .then(() => {
                    expect(store.getActions().toEqual(expectedActions));
                });
        });
        ...
        it('should remove movie from cart', () => {
            const movieCart = { type: types.REMOVE_MOVIE_CART_ITEM, payload: { movieId: 1 } };
            ...
            store.dispatch(actions.removeMovieFromCart(movieCart.payload))
                .then(() => {
                    expect(store.getActions().toEqual(expectedActions));
                });
        });
        ...
        it('should remove serie from cart', () => {
            const serieCart = { type: types.REMOVE_SERIE_CART_ITEM, payload: { serieId: 2 } };
            ...
            store.dispatch(actions.removeSerieFromCart(serieCart.payload))
                .then(() => {
                    expect(store.getActions().toEqual(expectedActions));
                });
        });
